  ...
  <div class="windows-list pt-3">
    ...
    <template v-if="!isWindowCreationVisible">
      <div class="d-flex mb-2">
        <button type="button" class="btn btn-primary" @click="toggleWindowCreation">Create new window</button>
      </div>

      <windows-list-item v-for="window in windows"
                         :window="window"
                         :key="window.id"
    ...
    <template v-if="isWindowCreationVisible">
      <div class="d-flex mb-2">
        ...
        <button type="button" class="btn btn-danger" @click="toggleWindowCreation">Cancel</button>
      </div>
      ...
      <form>
        <input type="text" class="form-control mb-3" placeholder="Window name" v-model="name">
